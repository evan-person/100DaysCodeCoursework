...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        x = torch.index_select(self.embeddings,0,w.view(-1,)).view(w.shape[0],self.n_features*self.embed_size)
    ...
    def forward(self, w):
        ...
        _h = self.dropout(h)
        logits=  torch.matmul(  _h,self.hidden_to_logits_weight)+ self.hidden_to_logits_bias    
        ### END YOUR CODE
        return logits
